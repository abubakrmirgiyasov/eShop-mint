...
namespace Mint.WebApp.Identity.Migrations
{
    ...
    [Migration("20230725154634_UserAddressTable")]
    partial class UserAddressTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Mint.Domain.Models.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0602b2b9-9c30-4f0d-a150-212f0d1772bc"),
                            ConfirmationCode = 0,
                            ...
                            NumOfAttempts = 0,
                            Password = "ByUB+pnOaEo7CRn1UunjhS1Iza01xWxQV3l3BCri1YI=",
                            Phone = 89502768428L,
                            Salt = new byte[] { 10, 170, 60, 97, 174, 223, 124, 210, 127, 20, 211, 247, 172, 55, 42, 83 },
                            SecondName = "Абубакр"
                        },
                        new
                        {
                            Id = new Guid("42712038-3fac-4944-b3ad-88b24f09dd0d"),
                            ConfirmationCode = 0,
                            ...
                            IsSeller = false,
                            NumOfAttempts = 0,
                            Password = "tJn4Z0YgP0PkwCNf/lmSVPuGcoALOSOt1ztfGvJ1wWA=",
                            Phone = 83452763423L,
                            Salt = new byte[] { 10, 170, 60, 97, 174, 223, 124, 210, 127, 20, 211, 247, 172, 55, 42, 83 },
                            SecondName = "User"
                        });
            ...
            modelBuilder.Entity("Mint.Domain.Models.Identity.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UserId = new Guid("0602b2b9-9c30-4f0d-a150-212f0d1772bc")
                        },
                        new
                        {
                        ...
                        {
                            RoleId = new Guid("77a6e9b4-64b8-46f0-998d-f01dd0b5b2b4"),
                            UserId = new Guid("42712038-3fac-4944-b3ad-88b24f09dd0d")
                        },
                        new
                        {
                            RoleId = new Guid("8d8d8618-c897-48d4-bedc-83ba3db4b7e1"),
