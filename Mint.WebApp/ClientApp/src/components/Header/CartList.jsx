...
const CartList = () => {
  ...
  const removeItem = (item) => {
    ...
    let subTotatal = cardItemTotal.current.innerHtml;
    cardItemTotal.current.innerHtml = subTotatal - price;

    item.closest(".dropdown-item-cart").remove();
    const element = document.querySelectorAll(".dropdown-item-cart").length;
    const cart = document.getElementById("empty-cart");
    cart.style.display = element === 0 ? "block" : "none";
    setCartItem(element);
  };
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <div className="flex-1">
                      <h6 className="mt-0 mb-1 fs-14">
                        <Link
                          to="/apps-ecommerce-product-details" // here /id also
