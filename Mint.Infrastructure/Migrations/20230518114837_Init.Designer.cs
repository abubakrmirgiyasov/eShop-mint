            ...
            modelBuilder.Entity("Mint.Domain.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreactionDate = new DateTime(2023, 5, 18, 18, 48, 36, 704, DateTimeKind.Local).AddTicks(7513),
                            Name = "Админ"
                        },
                        new
                        {
                            Id = new Guid("8d8d8618-c897-48d4-bedc-83ba3db4b7e1"),
                            CreactionDate = new DateTime(2023, 5, 18, 18, 48, 36, 704, DateTimeKind.Local).AddTicks(7622),
                            Name = "Продавец"
                        },
                        new
                        {
                            Id = new Guid("4d442669-abe7-4726-af0f-5734879a113c"),
                            CreactionDate = new DateTime(2023, 5, 18, 18, 48, 36, 704, DateTimeKind.Local).AddTicks(7626),
                            Name = "Покупатель"
                        });
                });
            ...
            modelBuilder.Entity("Mint.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("442383b8-03df-4d49-b421-43ee49a4613e"),
                            CreatedDate = new DateTime(2023, 5, 18, 18, 48, 36, 703, DateTimeKind.Local).AddTicks(9228),
                            ...
                            NumOfAttempts = 0,
                            Password = "qnjxBq4lV1oc2Ic8FI1km46pwcJNRrIkbunb90R/4FY=",
                            Phone = 89502768428L,
                            Salt = new byte[] { 150, 117, 93, 175, 203, 22, 254, 69, 114, 243, 74, 224, 172, 15, 239, 237 },
                            SecondName = "Абубакр"
                        },
                        new
                        {
                            Id = new Guid("949c1881-3feb-4dea-9e3f-74c03c0900d1"),
                            CreatedDate = new DateTime(2023, 5, 18, 18, 48, 36, 704, DateTimeKind.Local).AddTicks(6161),
                            ...
                            IsConfirmedEmail = true,
                            NumOfAttempts = 0,
                            Password = "/ztIKCjVDU4qomZ0n3/aPBcCNMChOjJbwImXPgW/GcA=",
                            Phone = 83452763423L,
                            Salt = new byte[] { 150, 117, 93, 175, 203, 22, 254, 69, 114, 243, 74, 224, 172, 15, 239, 237 },
                            SecondName = "User"
                        });
            ...
            modelBuilder.Entity("Mint.Domain.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UserId = new Guid("442383b8-03df-4d49-b421-43ee49a4613e")
                        },
                        new
                        {
                        ...
                        {
                            RoleId = new Guid("77a6e9b4-64b8-46f0-998d-f01dd0b5b2b4"),
                            UserId = new Guid("949c1881-3feb-4dea-9e3f-74c03c0900d1")
                        },
                        new
                        {
                            RoleId = new Guid("8d8d8618-c897-48d4-bedc-83ba3db4b7e1"),
