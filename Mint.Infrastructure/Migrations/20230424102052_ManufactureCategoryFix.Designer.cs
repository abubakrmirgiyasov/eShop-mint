...
namespace Mint.Infrastructure.Migrations
{
    ...
    [Migration("20230424102052_ManufactureCategoryFix")]
    partial class ManufactureCategoryFix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Mint.Domain.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreactionDate = new DateTime(2023, 4, 24, 17, 20, 52, 383, DateTimeKind.Local).AddTicks(2737),
                            Name = "Админ"
                        },
                        new
                        {
                            Id = new Guid("8d8d8618-c897-48d4-bedc-83ba3db4b7e1"),
                            CreactionDate = new DateTime(2023, 4, 24, 17, 20, 52, 383, DateTimeKind.Local).AddTicks(2744),
                            Name = "Продавец"
                        },
                        new
                        {
                            Id = new Guid("4d442669-abe7-4726-af0f-5734879a113c"),
                            CreactionDate = new DateTime(2023, 4, 24, 17, 20, 52, 383, DateTimeKind.Local).AddTicks(2753),
                            Name = "Покупатель"
                        });
                });
            ...
            modelBuilder.Entity("Mint.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a998da2e-0387-4732-b526-c688990dbc46"),
                            CreatedDate = new DateTime(2023, 4, 24, 17, 20, 52, 381, DateTimeKind.Local).AddTicks(9563),
                            ...
                            NumOfAttempts = 0,
                            Password = "Tg9FAOzadnfSiAJEiDp5XuwZpjRC6xmN8OK6YiDXs34=",
                            Phone = 89502768428L,
                            Salt = new byte[] { 171, 65, 197, 245, 30, 196, 228, 141, 96, 206, 233, 166, 161, 69, 237, 146 },
                            SecondName = "Абубакр"
                        },
                        new
                        {
                            Id = new Guid("9dd28ead-5606-4be0-b246-05e967f80cd8"),
                            CreatedDate = new DateTime(2023, 4, 24, 17, 20, 52, 383, DateTimeKind.Local).AddTicks(2655),
                            ...
                            IsConfirmedEmail = true,
                            NumOfAttempts = 0,
                            Password = "hXVtm1tFCUVxh4dUzlLRdIyK/FtTAPYTAvCKjbc1IiY=",
                            Phone = 83452763423L,
                            Salt = new byte[] { 171, 65, 197, 245, 30, 196, 228, 141, 96, 206, 233, 166, 161, 69, 237, 146 },
                            SecondName = "User"
                        });
            ...
            modelBuilder.Entity("Mint.Domain.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UserId = new Guid("a998da2e-0387-4732-b526-c688990dbc46")
                        },
                        new
                        {
                        ...
                        {
                            RoleId = new Guid("77a6e9b4-64b8-46f0-998d-f01dd0b5b2b4"),
                            UserId = new Guid("9dd28ead-5606-4be0-b246-05e967f80cd8")
                        },
                        new
                        {
                            RoleId = new Guid("8d8d8618-c897-48d4-bedc-83ba3db4b7e1"),
