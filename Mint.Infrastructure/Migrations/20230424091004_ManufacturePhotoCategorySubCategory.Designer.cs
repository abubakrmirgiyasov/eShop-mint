...
namespace Mint.Infrastructure.Migrations
{
    ...
    [Migration("20230424091004_ManufacturePhotoCategorySubCategory")]
    partial class ManufacturePhotoCategorySubCategory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Mint.Domain.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreactionDate = new DateTime(2023, 4, 24, 16, 10, 3, 880, DateTimeKind.Local).AddTicks(135),
                            Name = "Админ"
                        },
                        new
                        {
                            Id = new Guid("8d8d8618-c897-48d4-bedc-83ba3db4b7e1"),
                            CreactionDate = new DateTime(2023, 4, 24, 16, 10, 3, 880, DateTimeKind.Local).AddTicks(147),
                            Name = "Продавец"
                        },
                        new
                        {
                            Id = new Guid("4d442669-abe7-4726-af0f-5734879a113c"),
                            CreactionDate = new DateTime(2023, 4, 24, 16, 10, 3, 880, DateTimeKind.Local).AddTicks(156),
                            Name = "Покупатель"
                        });
                });
            ...
            modelBuilder.Entity("Mint.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("751f7274-0e16-43ce-8c76-f4ab354a0b3b"),
                            CreatedDate = new DateTime(2023, 4, 24, 16, 10, 3, 878, DateTimeKind.Local).AddTicks(5409),
                            ...
                            NumOfAttempts = 0,
                            Password = "u8g7kg3AVwYXMcIQkuK7l12CtvankA3cbskzD3AAu+Y=",
                            Phone = 89502768428L,
                            Salt = new byte[] { 241, 236, 163, 155, 150, 91, 138, 4, 27, 226, 67, 86, 54, 85, 71, 190 },
                            SecondName = "Абубакр"
                        },
                        new
                        {
                            Id = new Guid("6815eb20-ec7d-425f-a7a5-5cf35a499ccb"),
                            CreatedDate = new DateTime(2023, 4, 24, 16, 10, 3, 880, DateTimeKind.Local).AddTicks(3),
                            ...
                            IsConfirmedEmail = true,
                            NumOfAttempts = 0,
                            Password = "fP+TZIuJUDBSi9sCl6rSSLBMcuJuM97dSS6bK+Aa0Fc=",
                            Phone = 83452763423L,
                            Salt = new byte[] { 241, 236, 163, 155, 150, 91, 138, 4, 27, 226, 67, 86, 54, 85, 71, 190 },
                            SecondName = "User"
                        });
            ...
            modelBuilder.Entity("Mint.Domain.Models.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UserId = new Guid("751f7274-0e16-43ce-8c76-f4ab354a0b3b")
                        },
                        new
                        {
                        ...
                        {
                            RoleId = new Guid("77a6e9b4-64b8-46f0-998d-f01dd0b5b2b4"),
                            UserId = new Guid("6815eb20-ec7d-425f-a7a5-5cf35a499ccb")
                        },
                        new
                        {
                            RoleId = new Guid("8d8d8618-c897-48d4-bedc-83ba3db4b7e1"),
